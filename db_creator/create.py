...
CREATE TABLE IF NOT EXISTS SheetsInfo (
    ...
    get_data_metod TEXT DEFAULT 'get_default',
    scan_group TEXT,
    last_scan TEXT,
    ...
    hash TEXT,
    process_data_metod TEXT DEFAULT 'process_default',
    values_json TEXT,
    target_table_type TEXT NOT NULL,
    target_page_name TEXT NOT NULL,
    target_page_area TEXT NOT NULL,
    import_data_metod TEXT DEFAULT 'import_default',
    update_group TEXT,
    last_update TEXT,
...
CREATE TABLE IF NOT EXISTS RotationsInfo (
    ...
    source_page_name TEXT NOT NULL,
    source_page_area TEXT NOT NULL,
    get_data_metod TEXT DEFAULT 'get_rotation',
    scan_group TEXT,
    last_scan TEXT,
    ...
    target_page_name TEXT NOT NULL,
    target_page_area TEXT NOT NULL,
    import_data_metod TEXT DEFAULT 'import_rotation',
    update_group TEXT,
    last_update TEXT,
    update_quantity INTEGER DEFAULT 0,
    update_failures INTEGER DEFAULT 0,
